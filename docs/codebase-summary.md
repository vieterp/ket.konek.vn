...
**Cập nhật:** 2026-08-31 (lát 6G-2) · **Trạng thái:** phase 1 xong; phase 2 xong lát 2A–2C-5 (còn 2C-6: spike S1 esign + S4 đóng gói, chờ phần cứng); **phase 3 xong**; **phase 4 xong** (posting engine, sổ cái hai sổ, số dư ban đầu, khóa kỳ, toàn vẹn); phase 5 xong lát 5A–5E (gói cấu hình, formula engine, statement builder, report engine metadata-driven, render job nền); **phase 6 xong** (6A: protocol, guards, auto-posting, TK ngân hàng; 6B: quỹ tiền mặt; 6C: thủ quỹ, bank, engine đối trừ chung; 6D: sao kê, đối chiếu, 2FA, số dư đầu kỳ chia TK; 6E-1: BFF, 9 báo cáo metadata; 6E-2: mẫu in 01-TT/02-TT; 6F: UI "Tiền vào tiền ra"; 6G-1: chiều bank_account, RLS sao kê; 6G-2: CRUD hồ sơ sao kê, đóng băng kernel).
