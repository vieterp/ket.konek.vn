...
liệu, phân quyền tầng DB, nhật ký, phép tính tiền, danh tính), **posting engine + sổ cái hai sổ** (phase 4), **gói cấu hình TT99/TT133** (5A), **formula engine & statement builder** (5B), **report engine metadata-driven** (5C–5D), **render job nền** (5E), **protocol liên-module RT-18 + guards + auto-posting** (6A), **module quỹ tiền mặt (cash_book) hoàn chỉnh** (6B), **module ngân hàng (bank) + thủ quỹ (warehousing/treasurer) server** (6C), **sao kê + đối chiếu ngân hàng + số dư đầu kỳ ngân hàng** (6D), **BFF cashflow + 9 báo cáo phân hệ metadata-driven** (6E-1), **mẫu in chứng từ tiền 01-TT/02-TT/08a-TT** (6E-2), **chiều `bank_account` trên dòng sổ + RLS sao kê** (6G-1); phía client có **trọn bộ UI "Tiền vào tiền ra"** — thẻ + lưới + form phiếu, kiểm kê quỹ (6F-1), đối chiếu ngân hàng + thủ quỹ (6F-2). **Chưa có** phần chốt 6G-2 (màn khai hồ sơ sao kê, bước 22 rà hạ tầng, bước 23 đóng băng kernel), module mua/bán/kho/lương/thuế (phase 7–9).
...
Lát **6G-2** (chốt phase 6): màn khai hồ sơ sao kê, quyền unmatch xuyên phạm vi (chờ quyết định sản phẩm), nhãn ngoài-phạm-vi màn đối chiếu, bốn câu hỏi sản phẩm 6G-1 hoãn lại (đối chiếu không phủ phiếu quỹ; sao kê TK dùng chung; `F01-DNN` không cổng; đường `recompute` chiều đã ghi), **bước 22** rà hạ tầng + **bước 23** đóng băng kernel — trong đó phải quyết số phận Protocol `DepositMovementSource` (nay KHÔNG còn người gọi sau 6G-1); sau đó → mua hàng (PUR, phase 7); lát **2C**: client UI Báo cáo + design system mở rộng (lưới render).
