...
| `modules/*` | `cash_book/` (6B–6C, +`balance_service` 6E-1); `bank/`, `warehousing/treasurer/` (6C–6E-1); `general_ledger/journal/` (phase 4); `receivables/` (7A, +`guards.py` 7B); `purchase/` (7B, server; **chưa có UI client**); còn lại chỉ có `contracts.py` rỗng — chỗ giữ sẵn cho phase 7C–9 | — |
