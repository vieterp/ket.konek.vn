...
| **7** | [Mua – Bán – Công nợ & HĐĐT](../plans/260814-2204-accounting-system-architecture/phase-07-mua-b-n-c-ng-n-h-t.md) | P1 | 6 | 7w | PUR + SAL + EIV + INV + module `receivables` AR/AP; **ký esign đồng bộ** lúc phát hành; outbox | **Xong 2026-09-19 (trừ 7E-4)** — lát 7A xong 2026-09-01 (sổ phụ công nợ `ar_ap_ledger` + module `receivables`); lát 7B xong 2026-09-03 (module `purchase` server — hóa đơn mua, chi phí mua hàng phân bổ, guard ngưỡng nợ đối tác FR-SYS-032; UI client ở 7H-1 xong 2026-09-18); **7C tách ba lát** (user chốt 2026-09-04) — lát 7C-1 xong 2026-09-04 (danh mục **bảng giá** thứ 22 + bảng giá nhiều mức theo đơn vị FR-SYS-042 + bậc chiết khấu theo số lượng FR-SYS-045 + tùy chọn giá sau thuế FR-SYS-043 + bộ định giá `kernel/pricing`; chưa có UI client), lát 7C-2 xong 2026-09-05 (module `sales` server — hóa đơn bán năm nghiệp vụ, chiết khấu thương mại trừ thẳng trên dòng, trả lại/giảm giá đối trừ hóa đơn gốc, định giá theo lô; chưa có UI client), 7C-3→7G-5 xong (GLE sinh sổ phụ, HĐĐT nền + pipeline + adapter + sai sót + đầu vào, ~40 báo cáo, hai BFF, văn bản đối tác — xem plan); **7H chia ba (2026-09-18)**: 7H-1 UI mua hàng xong 2026-09-18; 7H-2 chia đôi — 7H-2a UI bán hàng và 7H-2b (đối trừ GLE + màn khai giá) xong 2026-09-18, 7H-3 UI HĐĐT xong 2026-09-18; **phase đóng 2026-09-19** trừ 7E-4 ký XAdES chờ `esign.konek.vn` (kiểm lại 2026-09-19: chưa có) |
| **8** | [Kho & CCDC & TSCĐ](../plans/260814-2204-accounting-system-architecture/phase-08-kho-ccdc-tsc.md) | P1 | 6 | 7w | STK + CCD + TSC; giá xuất 4 PP; recalc lùi ngày; khấu hao; phân bổ; số dư đầu kỳ nhóm 5–9 | **Đang làm** — chia 8 lát 8A→8H (user chốt 2026-09-19); **8A xong 2026-09-19** (nền kho: phiếu NK/XK/CK + sổ kho + cầu mua/bán + 3 guard + mục kiểm khóa sổ, ADR-024); **8B xong 2026-09-19** (engine giá xuất 4 phương pháp SQL set-based, job `inventory.costing.recalc`, repost giá vốn ADR-025, xem trước FR-STK-003, spike 100k dòng dưới mốc); **8C-1 xong 2026-09-19** (số dư đầu kỳ tồn kho nhóm 5 theo lớp qua cổng `OPENING_DETAIL_PORTS`, `carry_forward` nhóm 5, FR-STK-007 bình quân không theo kho, FR-STK-004 hàng bán trả lại lấy giá lần xuất, ADR-026); **8C-2 xong 2026-09-19** (lắp ráp/tháo dỡ hai loại phiếu LR/TD giá vế nhập suy từ vế xuất mỗi vòng engine, định mức NVL `item_bom_lines` + API + thẻ UI, lần nhập đích danh trên dòng hóa đơn bán, FR-STK-008 danh sách phiếu chưa tính giá + nhóm "chưa tính giá" tab việc còn thiếu, ADR-027); **8D xong 2026-09-23** ("Có thể bán" U7 qua `CommitmentProvider` cài ở `sales` — nguồn cam kết là hóa đơn bán chưa rời kho vì hệ thống không có chứng từ đơn đặt hàng; kiểm kê kho U8 sinh phiếu điều chỉnh nháp với cặp TK đọc thẳng `purpose`; phân hệ thủ kho khuôn 6C + sổ kho/thẻ kho; hàng giữ hộ BR-STK-07 qua `is_custodial` + `CostState.NOT_APPLICABLE`; check sổ kho ↔ sổ kế toán kho vào registry, check giá trị tồn ↔ sổ cái cố ý đứng ngoài (đỏ oan trên ba luồng đúng, dời 8F); ADR-028); tiếp 8E (TSCĐ + CCDC + chi phí trả trước) |
