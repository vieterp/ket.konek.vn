...
`konek.posting` và `konek.modules.*`, mà `kernel` **không được** import hai chỗ
...
from konek.kernel.auditing import models as auditing_models
from konek.kernel.idempotency import models as idempotency_models
from konek.kernel.jobs import models as jobs_models
from konek.kernel.numbering import models as numbering_models
from konek.kernel.persistence.base import ControlBase, DatasetBase
from konek.kernel.security import models as security_models
