...
2. `set_config('konek.branch_ids', …, local)` → phạm vi RLS (RT-04). Thiếu
...
from konek.kernel.auditing.listener import (
    AUDIT_CONTEXT_KEY,
    AuditContext,
    register_audit_listener,
)
from konek.kernel.security.rls import set_search_path_statement
from konek.kernel.security.tenant import set_branch_scope
