...
from konek.kernel.persistence.types import AuditValues, JsonPrimitive

AUDIT_CONTEXT_KEY: Final[str] = "konek_audit_context"
_PENDING_KEY: Final[str] = "konek_audit_pending"
...
def _capture(session: Session, _flush_context: object, _instances: object) -> None:
    ...
    if not isinstance(context, AuditContext):
        raise AuditContextMissingError(
            ...
            "Mở transaction bằng konek.kernel.persistence.unit_of_work.unit_of_work.",
